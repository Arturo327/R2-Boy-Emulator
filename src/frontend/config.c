...
const ActionMeta ACTIONS[ACT_COUNT] =
{
	...
	[ACT_PAUSE]	= { "PAUSE",	"pause",	offsetof(Keymap, pause),	offsetof(Padmap, pause)	},
	[ACT_ON]	= { "ON",	"on",		offsetof(Keymap, on),		offsetof(Padmap, on)	},
	[ACT_SCREENSHOT]= { "SCREENSHOT","screenshot",	offsetof(Keymap, screenshot),	offsetof(Padmap, screenshot)},
...
void default_keymap (Keymap *k)
{
	static const struct {
		...
		{ ACT_PAUSE,	SDL_SCANCODE_F9		},
		{ ACT_ON,	SDL_SCANCODE_F10	},
		{ ACT_SCREENSHOT,SDL_SCANCODE_F12	},
...
void default_padmap (Padmap *p)
{
	static const struct {
		...
		{ ACT_PAUSE,	SDL_CONTROLLER_BUTTON_INVALID	},
		{ ACT_ON,	SDL_CONTROLLER_BUTTON_INVALID	},
		{ ACT_SCREENSHOT,SDL_CONTROLLER_BUTTON_INVALID	},
